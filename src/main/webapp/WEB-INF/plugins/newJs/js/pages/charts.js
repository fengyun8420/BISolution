...
$(document).ready(function() {
	...
	randNum = function(){
		return (Math.floor( Math.random()* (100+15000-5000) ) ) + 8000;
	}
	...
	$(function() {
		...
		//here we generate randomdata data for chart
		for (var i = -7; i < 1; i++) {
			d1.push([new Date(Date.today().add(i).days()).getTime(),randNum2()]);
		}
	...
	$(function () {	
    	...
    	var data = [ ["JAN", 288380], ["FEB", 303450], ["MAR", 338203], ["APR", 316708], ["MAY", 347802], ["JUN", 315009], ["JUL", 313505], ["AUG", 317008], ["SEP", 308908], ["OCT", 325052], ["NOV", 319507], ["DEC", 359058] ];
	...
	$(function () {
	    ...
	    for (var i = 1; i <= 12; i += 1)
	        d1.push([i, parseInt(Math.random() * 10) + 40]);
	 
	    var d2 = [];
	    for (var i = 1; i <= 12; i += 1)
	        d2.push([i, parseInt(Math.random() * 30 + 200)]);
	 
	    var ds = new Array();
	 
	    ds.push({
	     	label: "AvgDwellTime(min)",
	        data:d1,
	        bars: {order: 1}
	    });
	    ds.push({
